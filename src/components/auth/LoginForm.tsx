  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-brand-charcoal">Login</h1>
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <a href="#" className="font-medium text-brand-yellow hover:underline underline-offset-4">
            Forgot Password?
          </a>
        </div>
